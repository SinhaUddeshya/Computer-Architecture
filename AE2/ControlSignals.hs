...
data CtlSig a = CtlSig
  {
-- Controls for MUL
   ctl_mul_st,  --   1-bit alu operation code
...
-- Controls for register file
   ...
   ctl_rf_mul,    -- Input to register file is mul output prod 
   ctl_rf_increment,  -- If the rf increment control signal is 0 then use ir_d as the input, else if it is 1 then use ir_sa
